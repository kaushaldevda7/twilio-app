                  ...
                  return __generator(this, function(_a2) {
                    switch (_a2.label) {
                      ...
                      case 1:
                        ...
                        if (!device) {
                          return [2, Promise.reject(new errors_1.InvalidArgumentError("Device not found: " + deviceId))];
                        }
    ...
    var PreflightTest = (
      ...
      function(_super) {
        ...
        PreflightTest2.prototype._emitWarning = function(name, description, rtcWarning) {
          ...
          this._log.debug("#" + PreflightTest2.Events.Warning, JSON.stringify(warning));
        ...
        PreflightTest2.prototype._onFailed = function(error) {
          ...
          this._log.debug("#" + PreflightTest2.Events.Failed, error);
        ...
        PreflightTest2.prototype._onUnregistered = function() {
          ...
          setTimeout(function() {
            ...
            _this._log.debug("#" + PreflightTest2.Events.Completed, JSON.stringify(_this._report));
        ...
        PreflightTest2.prototype._setupCallHandlers = function(call) {
          ...
          call.once("accept", function() {
            ...
            _this._log.debug("#" + PreflightTest2.Events.Connected);
              ...
              return __generator(this, function(_b) {
                switch (_b.label) {
                  ...
                  case 2:
                    ...
                    this._log.debug("#" + PreflightTest2.Events.Sample, JSON.stringify(sample));
...
var require_rtcpeerconnection = __commonJS({
  "node_modules/rtcpeerconnection-shim/rtcpeerconnection.js"(exports, module) {
    ...
    module.exports = function(window2, edgeVersion) {
      ...
      RTCPeerConnection2.prototype._createTransceiver = function(kind) {
      ...
      RTCPeerConnection2.prototype.getStats = function() {
        var promises = [];
        this.transceivers.forEach(function(transceiver) {
          [
            "rtpSender",
...
var require_rtcpc = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/rtc/rtcpc.js"(exports) {
    ...
    var RTCPeerConnectionShim = require_rtcpeerconnection();
        ...
        _this._onAnswerOrRinging = function(payload) {
          ...
          if (_this.status !== "closed") {
            _this.version.processAnswer(_this.codecPreferences, sdp, null, function(err) {
              ...
              _this._log.error("Failed to process answer during ICE Restart. Error: " + message2);
            });
          }
        };
...
// node_modules/@twilio/voice-sdk/es5/twilio/uuid.js
var require_uuid = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/uuid.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.generateVoiceEventSid = void 0;
    var md5Lib = require_md5();
    var errors_1 = require_errors();
    ...
    function generateUuid() {
      ...
      if (typeof (crypto.randomUUID || crypto.getRandomValues) === "undefined") {
        throw new errors_1.NotSupportedError("Neither `crypto.randomUUID` or `crypto.getRandomValues` are available on this platform.");
      }
      ...
      var generateRandomValues = typeof crypto.randomUUID === "function" ? function() {
        return crypto.randomUUID();
      } : function() {
        return crypto.getRandomValues(new Uint32Array(32)).toString();
      };
      ...
      function(_super) {
        ...
        function Device2(token, options) {
          ...
          _this._onSignalingConnected = function(payload) {
            ...
            (_a2 = _this._publisher) === null || _a2 === void 0 ? void 0 : _a2.setHost(regions_1.createEventGatewayURI(payload.home));
            if (payload.token) {
          ...
          if (typeof Device2._isUnifiedPlanDefault === "undefined") {
            Device2._isUnifiedPlanDefault = typeof window !== "undefined" && typeof RTCPeerConnection !== "undefined" && typeof RTCRtpTransceiver !== "undefined" ? util_1.isUnifiedPlanDefault(window, window.navigator, RTCPeerConnection, RTCRtpTransceiver) : false;
          }
        ...
        Device2.prototype.connect = function(options) {
          if (options === void 0) {
            options = {};
          }
          return __awaiter(this, void 0, void 0, function() {
              ...
              switch (_a.label) {
                case 0:
                  ...
                  if (this.state !== Device2.State.Unregistered) {
                    throw new errors_1.InvalidStateError('Attempt to register when device is in state "' + this.state + '". ' + ('Must be "' + Device2.State.Unregistered + '".'));
                  }
                ...
                case 2:
                  _a.sent();
                  return [4, util_1.promisifyEvents(this, Device2.State.Registered, Device2.State.Unregistered)];
                case 3:
                  _a.sent();
                  return [
                    2
              ...
              switch (_a.label) {
                case 0:
                  ...
                  if (this.state !== Device2.State.Registered) {
                    throw new errors_1.InvalidStateError('Attempt to unregister when device is in state "' + this.state + '". ' + ('Must be "' + Device2.State.Registered + '".'));
                  }
                  this._shouldReRegister = false;
        ...
        Device2.prototype.updateOptions = function(options) {
          ...
          for (var _a = 0, _b = Object.keys(Device2._defaultSounds); _a < _b.length; _a++) {
            ...
            var defaultUrl = C.SOUNDS_BASE_URL + "/" + soundDef.filename + "." + Device2.extension + ("?cache=" + C.RELEASE_VERSION);
        ...
        Device2.prototype._makeCall = function(twimlParams, options, isReconnect) {
          var _a;
      ...
      function(_super) {
        ...
        Call2.prototype.postFeedback = function(score, issue) {
          ...
          if (!Object.values(Call2.FeedbackScore).includes(score)) {
            throw new errors_1.InvalidArgumentError("Feedback score must be one of: " + Object.values(Call2.FeedbackScore));
          }
          if (typeof issue !== "undefined" && issue !== null && !Object.values(Call2.FeedbackIssue).includes(issue)) {
            throw new errors_1.InvalidArgumentError("Feedback issue must be one of: " + Object.values(Call2.FeedbackIssue));
          }
